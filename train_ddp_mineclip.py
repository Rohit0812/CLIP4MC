...
def main(args):
    ...
    train_dataloader, train_sampler, train_length \
        = get_naive_dataloader(args.use_mask, args.batch_size, 'train', args.num_workers)
    test_dataloader, test_sampler, test_length \
        = get_naive_dataloader(args.use_mask, args.batch_size_test, 'test', args.num_workers)
